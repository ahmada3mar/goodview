<template>
                        <UForm class="flex flex-1 max-w-96 flex-col bg-gray-100 dark:bg-gray-900 p-5 rounded-lg z-10">
                        ...
                        <UButton class="my-4 p-3 px-7 bg-primary-500 rounded-full ml-auto" type="submit" label="Get A free quote" />
                    </UForm>
</template>