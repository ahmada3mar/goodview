    ...
    <div class="bg-primary-50">
      <div class="container mx-auto">
        ...
        <div class="flex flex-col my-16 md:my-36 justify-center items-center px-4 md:px-36">
          <h2 class="mb-5 px-4 text-center">Get An Affordable Moving Service Estimate</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 px-4">
          <UCard :ui="{  rounded: 'rounded-2xl'}">
            <div class="flex flex-col gap-5">
              ...
              <h2 class="font-bold">Affordable Rates</h2>
          ...
          <UCard :ui="{  rounded: 'rounded-2xl'}">
            <div class="flex flex-col gap-5">
              ...
              <h2 class="font-bold">Detailed Estimates</h2>
              <p class="text-lg md:text-xl">
          ...
          <UCard :ui="{  rounded: 'rounded-2xl'}">
            <div class="flex flex-col gap-5">
              ...
              <h2 class="font-bold">Pro Moving Crews</h2>
              <p class="text-lg md:text-xl">
          ...
          <UCard :ui="{  rounded: 'rounded-2xl'}">
            <div class="flex flex-col gap-5">
              ...
              <h2 class="font-bold">Guaranteed Protection</h2>
              <p class="text-lg md:text-xl">
