<template>
  <div class="bg-black py-5 footer rounded-none text-white">
    <div class="container mx-auto">
      <div
        class="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-12 px-7 py-10"
      >
        <!-- Logo and Description -->
        <div class="flex flex-col w-full mx-auto gap-5 items-start">
          <img
            class=""
            src="/imgs/good-view-logo-white.png"
            alt="good view logo"
          />
          <div class="flex flex-col gap-2 it md:items-start">
            ...
            <div class="flex gap-4 mt-2">
              <ULink
                to="https://www.facebook.com/people/Goodview-Moving-And-Storage/61576011192616/"
                target="_blank"
                aria-label="Visit Goodview Moving on Facebook"
              >
                <UIcon
                  name="i-mdi-facebook"
                  class="w-[45px] h-[45px] text-primary-500"
                />
              </ULink>

              <ULink
                to="https://www.instagram.com/goodviewmoving/"
                target="_blank"
              ...
              <ULink
                to="https://www.pinterest.com/goodviewmoving/"
                target="_blank"
              ...
              <ULink
                to="https://www.linkedin.com/company/goodview-moving-storage/"
                aria-label="Follow Goodview Moving on LinkedIn"
                target="_blank"
        ...
        <div class="flex flex-col w-full mx-auto gap-5">
          ...
          <div class="flex w-full flex-col gap-2">
            <ULink
              to="/"
              class="text-start font-rubik text-[16px] hover:text-primary-500"
              >Home</ULink
            >
            <ULink
              to="/about-us/"
        ...
        <div class="flex flex-col w-full mx-auto gap-5">
          ...
          <div class="flex w-full flex-col gap-2">
            ...
            <ULink
              ...
              class="text-start font-rubik text-[16px] hover:text-primary-500"
              >Furniture Assembly and Disassembly</ULink
            >
            <ULink
          ...
          <div class="justify-center">
            <div class="flex w-full gap-1 sm:gap-3">
              ...
              <div
                ...
                class="flex bg-opacity-35 hover:text-primary-500 rounded-full p-1 font-rubik text-[16px] text-white font-[400]"
              >
                <span itemprop="telephone"
                  ><a href="tel:+19737821339">+1 973-782-1339</a></span
                >
              </div>
            </div>
            <div class="flex w-full gap-1 sm:gap-3">
              ...
              >
                <span itemprop="email">
                  <ULink
                    class="inline-block break-all max-w-full"
                    to="mailto:Service@fasttransportation.info"
                  >
            ...
            <div class="flex w-full gap-1 sm:gap-3">
              ...
              <div
                itemscope
                itemtype="http://schema.org/LocalBusiness"
                class="flex font-[400] bg-opacity-35 font-rubik text-[16px] rounded-full p-1 text-white"
              >
                <span itemprop="email">490 riverview dr, Totowa NJ, 07512</span>
              </div>
            </div>
      ...
      <div
        class="text-center py-4 font-jakarta text-[16px] font-[300] text-white px-3"
      >
