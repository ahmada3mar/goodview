    ...
    <div class="container mx-auto px-5">
      ...
      <div class="flex flex-wrap gap-10 lg:gap-20 items-center py-10 md:py-20">
        <div class="img1 relative bg-primary-500 rounded-2xl p-2 w-full lg:w-1/2">
          <img class="w-full h-auto rounded-lg" src="~/assets/details1.png" alt="Details Image 1 goodview">
          <div class="dot"></div>
          <div class="dot"></div>
        </div>
      ...
      <div class="flex flex-wrap gap-10 lg:gap-20 items-center py-10 md:py-20">
        ...
        <div class="img1 relative bg-primary-500 rounded-2xl p-2 w-full lg:w-1/2">
          <img class="w-full h-auto rounded-lg" src="~/assets/details2.png" alt="Details Image goodview">
          <div class="dot"></div>
          <div class="dot"></div>
        </div>
      </div>
