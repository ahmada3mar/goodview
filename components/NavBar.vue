      ...
      <div class="container flex flex-row md:flex-row h-20 justify-between items-center">
        ...
        <div class="hidden h-full lg:flex items-center gap-1 lg:gap-[6px] xl:gap-10 text-sm font-bold text-white">
          ...
          <div class="relative" @mouseenter="showDropdown1 = true" @mouseleave="showDropdown1 = false">
            ...
            <div v-if="showDropdown1" class="absolute left-0 gap-2 w-[250px] bg-primary-500 text-black shadow-lg z-50">
          ...
          <div class="relative" @mouseenter="showDropdown2 = true" @mouseleave="showDropdown2 = false">
            ...
            <!-- Dropdown Menu (Only Shows on Hover) -->
            <div v-if="showDropdown2" class="absolute left-0 gap-2 w-[250px] bg-primary-500 text-black shadow-lg z-50">
              <ULink to="/california/" class="block px-4 py-2 hover:bg-black hover:text-white text-[16px] font-jakarta">
                California
              </ULink>
              <ULink to="/north-carolina/"
                class="block px-4 py-2 hover:bg-black hover:text-white text-[16px] font-jakarta">North Carolina
              </ULink>
              <ULink to="/new-jersey/" class="block px-4 py-2 hover:bg-black hover:text-white text-[16px] font-jakarta">
                New Jersey
              </ULink>
              <ULink to="/new-york/" class="block px-4 py-2 hover:bg-black hover:text-white text-[16px] font-jakarta">
                New York
              </ULink>
              <ULink to="/georgia/" class="block px-4 py-2 hover:bg-black hover:text-white text-[16px] font-jakarta">
                Georgia
              </ULink>
              <ULink to="/texas/" class="block px-4 py-2 hover:bg-black hover:text-white text-[16px] font-jakarta">
                Texas
              </ULink>
            </div>
          </div>
        ...
        <UIcon @click="useSlideover().open(SideBar)" role="button" name="i-iconamoon-menu-burger-horizontal"
          class="block lg:hidden w-8 h-8 text-white" />
      </div>
    </div>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      showDropdown1: false, // First dropdown visibility
      showDropdown2: false, // Second dropdown visibility
    };
  },
};
</script>
