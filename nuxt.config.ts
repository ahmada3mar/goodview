...
export default defineNuxtConfig(
  ...
  app: {
    ...
    head: {
      ...
      meta: [
        { name: 'description', content: 'Get trusted moving services in USA, for home, office, Storing, and Relocation. Professional packing, safe transportation, and affordable pricing guaranteed.' },
