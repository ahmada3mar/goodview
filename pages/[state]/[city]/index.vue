<template>
  <div>
    <div v-if="isRoutePage&& urlStateObj && moving_route">
            ...
            <div class="relative w-full md:w-[65%] items-baseline justify-center gap-6  py-10 container h-full">
              ...
              <p class=" font-[300] max-w-3xl text-[18px]  tracking-[.3px] font-rubik leading-[1.6em]">
                Estimated Cost: A move from {{ fromCity }} to {{ toCity }} typically costs between<strong
                  ...
                  }}.</strong>The total cost and time depend on several factors, including the size of your move, your
                moving date,
                and whether you hire professional movers or handle the move yourself.</p>
              <p class=" font-[300] max-w-3xl text-[18px]  tracking-[.3px] font-rubik leading-[1.6em]">
          ...
          <div class='w-full md:w-[70%]'>
            <div class="bg-zinc-900 rounded-lg p-4 md:p-8">
              ...
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em]">
                AAt Good View Moving and Storage, we believe in providing clear, upfront pricing so you can +plan your
                move
                with confidence. Based on our experience helping customers relocate along this route, the average cost
                to move
                from {{ fromCity }} to {{ toCity }} typically falls between <strong
              ...
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">The final price
                depends on
                several factors, including the size of your move, the services you select, and your specific moving
                date.
              ...
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Here's a breakdown of
                the
                average
                moving costs
                for this route:</p>
              <div class="border rounded-md overflow-x-auto max-w-[350px] mx-auto mt-6"
                ...
                <table class="w-full text-left">
                  ...
                  <tbody>
                    <tr v-for="item in tableRows" :key="item.label" class="hover:bg-zinc-700">
                      <td class="px-4 font-rubik py-3">{{ item.label }}</td>
                      <td class="px-4 font-rubik py-3 text-center">${{ item.avg }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Please note: These
                price
                ranges are rough estimates based on our customer relocation data. The actual cost may vary depending on
                the
                size of your move, additional services required, truck parking access and availability.</p>
              ...
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">At Good View Moving
                and
                Storage, we believe every move is unique — and so is the final cost. Several key factors can influence
                the
                price of your move from {{ fromCity }} to {{ toCity }}.</p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Here's what can affect
                your
                moving
                cost with us:
              </p>
              <ul class='list-disc pl-7 font-rubik'>
                <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                    class='font-[600] text-[18px]'>Size
                    of Your Move: </strong> Larger homes or apartments mean more items to pack, load, and transport,
                  which can
                  increase the overall cost. For example, moving a 2-3 bedroom home will cost more than a small
                  apartment.
                </li>
                <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                    class='font-[600] text-[18px]'>Distance of the Move: </strong>Some customers book long distance
                  moving
                  services for routes beyond city limits, which affects pricing.</li>
                <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                    class='font-[600] text-[18px]'>Type of Services You Need: </strong> Full-service options, such as
                  professional packing, unpacking, furniture disassembly, or storage, will influence your total moving
                  cost.
                  We offer flexible packages for every need.</li>
                <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                    class='font-[600] text-[18px]'>Accessibility at Pickup and Drop-off Locations: </strong>If our
                  trucks have
                  limited access, elevators are unavailable, or parking is difficult, it may affect the price.</li>
                <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                    class='font-[600] text-[18px]'>Move Date and Time: </strong> Moving during peak seasons, weekends,
                  or
                  holidays can increase demand, which may raise rates. Booking early with Good View Moving often secures
                  better pricing.</li>
                <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                    class='font-[600] text-[18px]'>Specialty Items: </strong>Large or delicate items such as pianos,
                  antiques,
                  or fragile furniture may require extra care and add to the final cost.</li>

              </ul>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Our goal is to provide
                affordable long distance moving and local relocation services with clear, upfront pricing. Good View
                Moving
                and Storage is proud to be among the best moving companies serving this route.</p>
              <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">Benefits of Choosing Good
                View
                Moving for Your {{ fromCity }} to {{ toCity }} Move</h2>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">When you're planning a
                move
                from {{ fromCity }} to {{ toCity }}, you need a team you can rely on. At Good View Moving and Storage,
                we're
                proud to
                offer
                dependable, affordable, and stress-free moving solutions for both local and long distance moving.</p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Here's why so many
                customers
                consider
                us among
              ...
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                ...
                moves
                across the country and within your area. From packing to transport, your belongings are in safe hands.
              </p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                  class='font-[600] text-[18px]'>
                  <span style="color: #ffd343; margin-right: 6px;">✓</span> Affordable and Transparent Pricing:
                </strong> We
                believe in honest, upfront pricing. Whether you're looking for out of state movers, or full-service
                relocation, we offer solutions that fit your budget. </p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                  class='font-[600] text-[18px]'>
                  <span style="color: #ffd343; margin-right: 6px;">✓</span>
                ...
                packing,
                storage, and specialty item handling. Our long distance moving services can be customized to your needs.
              </p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                  class='font-[600] text-[18px]'>
                  <span style="color: #ffd343; margin-right: 6px;">✓</span> Highly Rated and Trusted: </strong>
                We take pride in positive Good View Moving reviews from satisfied customers. Our commitment to
                reliability,
                care, and customer service has made us a trusted name in the industry.</p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                  class='font-[600] text-[18px]'>
                  <span style="color: #ffd343; margin-right: 6px;">✓</span>
                  Stress-Free Moving Process: </strong>Our goal is simple — to make your move smooth and worry-free.
                Whether
                you need local help or expert long distance movers, we're with you every step of the way.
              </p>
              <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">Get an Instant Quote for
                Your Move Today
              </h2>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Planning a move
                doesn't have
                to be stressful — let Good View Moving and Storage make it simple. Whether you're relocating within {{
                  fromCity }} or heading across the country, we're here to help with transparent pricing and professional
                service.</p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">With just a few
                details, you
                can receive a fast and free quote tailored to your move. We provide honest estimates based on the size
                of your
                move, distance, and any additional services you may need, including packing or storage options.</p>
              <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Wondering What is the
                cheapest way to move long-distance? Start by getting your personalized quote with Good View Moving local
                moving services.</p>
              <p class="font-[700]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Get your instant quote
                today
                and see why we're considered one of the top-rated movers for both local and long-distance relocations.
              </p>
                    ...
                    <div v-for="(testimonial, index) in visibleTestimonials" :key="testimonial.id + '-' + index"
                      ...
                      <div class="mb-6">
                        <div class="flex items-center mb-5">
                          ...
                          <div class="flex-1">
                            <h3 class=" font-bold text-black font-jakarta text-[32px] tracking-tight">{{
                              testimonial.name
                            }}</h3>
    ...
    <div v-else-if="currentCityObj && urlStateObj && cityMatchesState" class="bg-black text-white">
          ...
          <div class="mb-8">
            ...
            <ul>
              <li v-for="route in filteredRoutes" :key="route.id" class="flex items-center mb-2">
                <svg fill="#ffffff" width="40px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M7.8 10a2.2 2.2 0 0 0 4.4 0 2.2 2.2 0 0 0-4.4 0z"></path></g></svg>
...
// Add: Find the state object by slug from the URL
const urlStateObj = computed(() => {
  if (!allStates.value) return null
  return allStates.value.find(state => state.slug === stateSlug) || null
})

// Add: Check if the city belongs to the state in the URL
const cityMatchesState = computed(() => {
  if (!currentCityObj.value || !urlStateObj.value) return false
  return String(currentCityObj.value.state_id) === String(urlStateObj.value.id)
})

// --- Route Page Logic ---
const isRoutePage = computed(() => {
  return allRoutes.value?.some(r => r.slug === citySlug)
})

console.log('citySlug:', citySlug, 'isRoutePage:', isRoutePage.value)
...
// Route details (for /city/[city]/[slug])
const moving_route = ref(null)
const fromCityObj = ref(null)
const fromStateObj = ref(null)

watchEffect(async () => {
  if (isRoutePage.value) {
    // Fetch the route details
    const { data } = await useFetch(`https://api.goodview-moving.com/api/routes/${citySlug}`)
    moving_route.value = data.value
  }
})

watchEffect(() => {
  if (allCities.value && moving_route.value) {
    fromCityObj.value = allCities.value.find(city => city.id === moving_route.value.moving_from_city?.id)
  }
  if (allStates.value && fromCityObj.value) {
    fromStateObj.value = allStates.value.find(state => String(state.id) === String(fromCityObj.value.state_id))
  }
})
...
const routeDescription = computed(() =>
  `Move from ${fromCity.value} to ${toCity.value} with ease. Good View Moving offers affordable and hassle-free relocation services. Get your free quote today.`
);
...
function getQuote() {
  ...
  router.push({ path: '/quote', query: { from: fromZIP.value, to: toZIP.value } })
}
...
const visibleTestimonials = computed(() => {
  ...
  const count = windowWidth.value < 576 || (windowWidth.value > 767 && windowWidth.value < 1100) ? 1 : 2
  const arr = []
  ...
  if (isRoutePage.value) {
    window.initMap = () => {
      if (moving_route.value) {
        nextTick(() => {
          initMap(fromCity.value, toCity.value)
        })
      }
    }
...
// Expose to template
// (all refs/computeds used in template must be returned or in <script setup>)

watchEffect(() => {
  console.log('citySlug:', citySlug)
  console.log('isRoutePage:', isRoutePage.value)
  console.log('currentCityObj:', currentCityObj.value)
})
</script>