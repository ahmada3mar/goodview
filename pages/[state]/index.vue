<template>
  <div>
    ...
    <div
      class="relative bg-cover bg-center overflow-hidden lg:h-[700px] flex items-center justify-center"
    ...
    >
      ...
      ></div>
      <div
        class="flex flex-row max-w-[1360px] w-full mx-auto justify-between items-center"
      >
        ...
        >
          ...
          <div
            class="text-left max-w-[48rem] state-content"
      ...
      <div class="max-w-[1020px] px-5 lg:px-0 mx-auto bg-zinc-900 lg:mx-auto">
        ...
        >
          ...
          <div class="text-center">
            ...
            <div
              class="!text-[16px] text-center state-content"
              v-html="state.intro_description"
            ></div>
    ...
    <div class="bg-black">
      <div
        class="flex flex-col px-5 lg:px-0 container md:flex-row items-center pt-[80px] mx-auto gap-[4.5rem]"
      >
        ...
        <div class="w-full md:w-[60%]">
          <h2
            class="text-3xl font-jakarta md:text-[48px] leading-normal text-white mb-5 font-extrabold"
          >
            {{ state.main_title }}
          </h2>
      ...
      >
        <img
          alt="company logo"
          class="lazy-image opacity-0"
          v-lazy="'/imgs/Logos-Banner (1).png'"
        />
      </div>
      ...
      <div class="max-w-[1020px] px-5 lg:px-0 mx-auto">
        ...
        <div class="w-[126px] h-[2px] my-5 bg-primary-500"></div>
        <div
          class="text-white state-content"
          v-html="state.sections[1].content"
        ></div>
          ...
          <div class="w-full md:w-1/2">
            <ul class="list-disc">
              <li
                ...
                :key="city.id"
                class="flex text-[18px] items-center mb-2"
              >
                <svg
                  fill="#FFFFFF"
                  width="30px"
              ...
              >
                ...
                <div class="mb-6">
                  <div class="flex items-center mb-5">
                    <div class="flex-1">
                      <h3
                        class="font-bold text-black text-[32px] tracking-tight"
                      >
                        {{ testimonial.name }}
                      </h3>
                    </div>
                ...
                <div class="relative">
                  <p class="text-black font-[300] text-[16px] leading-relaxed">
                    {{ testimonial.review }}
                  </p>
                </div>
              </div>
    ...
    <div class="bg-zinc-900">
      <div
        class="flex flex-col px-5 lg:px-0 container md:flex-row items-center py-[90px] mx-auto gap-[4.5rem]"
      >
        <!-- Image Section (Left - 40%) -->
        <div class="w-full md:w-[40%] card-img flex items-start justify-center">
          <img
            alt="Get Your Free Moving Estimate"
        ...
        <div class="w-full md:w-[60%]">
          ...
          <p
            class="text-[16px] font-rubik text-white md:text-[18px] md:font-[300] md:leading-8"
          >
            Planning a move in {{ state.name }}? Let Good View Moving and
            Storage take the stress off your shoulders.
          </p>
          <p
            class="text-[16px] font-rubik text-white md:text-[18px] md:font-[300] md:leading-8 mt-4"
          >
            We're here to answer your questions, guide you through the moving
            process, and provide the dependable service you can count on.
          </p>
          <p
            class="text-[16px] font-rubik text-white md:text-[18px] md:font-bold md:leading-8 mt-4"
          >
            Contact us today for a free moving estimate — and let us handle the
    ...
    <div class="bg-black px-[20px]">
      <div class="max-w-[1020px] mx-auto py-6">
        <h2 class="text-4xl font-bold mb-4 mt-12 pb-4 text-white font-jakarta">
        ...
        <div class="space-y-6 text-white">
          ...
          >
            ...
            <div v-if="openFaq === index" class="p-6">
              <p class="leading-[26px] md:leading-[32px] font-[300] font-rubik">
                {{ faq.answer }}
              </p>
            </div>
          </div>
...
const { data: state, error } = await useFetch(
  `https://api.goodview-moving.com/api/states/${id}`,
  {
...
const { data: city, error: cityError } = await useFetch(
  "https://api.goodview-moving.com/api/city",
  {
    onResponseError({ response }) {
...
const filteredCities = computed(() => {
  ...
  const filtered = city.value.filter(
    (c) => Number(c.state_id) === Number(state.value.id)
  );
  return filtered;
});
