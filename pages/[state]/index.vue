  ...
  <div>
    ...
    <div class="relative bg-cover bg-center overflow-hidden lg:h-[700px] flex items-center justify-center"
      ...
      <div class="flex flex-row max-w-[1360px] w-full mx-auto justify-between items-center">
        ...
        <div class="relative flex flex-col items-baseline justify-center text-center gap-3 px-5 py-10 container h-full">
    ...
    <div class="bg-black">
      ...
      <div class="max-w-[1020px] px-5 lg:px-0 mx-auto">
        ...
        <div class="flex md:flex-row flex-col justify-between">
          <div class="w-full md:w-1/2">
            <ul class="list-disc">
              <li v-for="city in leftCities" :key="city.id" class="flex text-[18px] items-center mb-2">
                ...
                <ULink :to="`/${state.slug}/${city.slug}/`" class="hover:text-primary-500 text-white transition-colors">
                  {{ city.name }}
                </ULink>
              </li>
            </ul>
          ...
          <div class="w-full md:w-1/2">
            <ul class="list-disc">
              <li v-for="city in rightCities" :key="city.id" class="flex items-center text-[18px] mb-[8px]">
                <svg fill="#FFFFFF" width="30px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                  <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                  <g id="SVGRepo_iconCarrier">
    ...
    <div class="bg-zinc-900">
      <div class="flex flex-col px-5 lg:px-0 container md:flex-row items-center py-[90px] mx-auto gap-[4.5rem]">
        ...
        <div class="w-full md:w-[40%] card-img flex items-start justify-center">
          <img alt="Get Your Free Moving Estimate" class="rounded-[10px] w-full h-auto" v-lazy="'/imgs/quote2.webp'" />
        </div>
        <!-- Text Section (Right - 60%) -->
        <div class="w-full md:w-[60%]">
          <h2 class="text-3xl font-jakarta md:text-[48px] leading-normal text-white mb-5 font-extrabold">
...
useHead(
  computed(() => ({
    title: `Trusted Moving Services in ${state.value.name}`,
    meta: [
      {
        name: "description",
        content: `Need trusted movers in ${state.value.name}? Good View Moving offers licensed local and long distance moving services with free quotes.`,
      },
      {
        name: "robots",
