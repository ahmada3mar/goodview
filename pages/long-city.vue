  ...
  <div>
    <div class="bg-gray-100 flex items-center justify-center">
      <div class="relative bg-cover bg-center overflow-hidden lg:h-[550px] flex items-center justify-center w-full"
        :style="{
          backgroundImage: 'url(\'https://goodview-moving.com/imgs/topbannerimage%20(1).png\')'
        }">
        ...
        <div
          ...
          <div class="relative w-full md:w-[65%] items-baseline justify-center gap-6 md:px-5 py-10 container h-full">
            ...
            <h1 class=" text-[24px] lg:text-[56px] mb-4 leading-normal font-[700] font-jakarta">
              <strong class="ttext-[32px] sm:text-[60px] text-[#ffd343]"> ($326)</strong> Moving Jersey City to
              Montclair
            </h1>
            <p class="text-[18px] md:text-xl font-light max-w-3xl font-rubik leading-[2rem]">
              Estimated Cost: A move from Jersey City to Montclair typically costs between<strong
      ...
      <div class='max-w-[1360px] w-full mx-auto flex flex-col lg:flex-row gap-8 px-[20px] md:px-0'>
        <div class='w-full md::w-[70%]'>
          <div class="bg-zinc-900 rounded-lg p-4 md:p-8">
            <h2 class="text-xl md:text-[38px] leading-normal font-[600] mb-6 font-jakarta">Cost of Moving from Jersey
              City to
              Montclair with Good View Moving?</h2>
            <p class="leading-[26px] md:leading-[32px] font-[300] mb-6">
              ...
              cost to move from Jersey City to Montclair typically falls between <strong
            ...
            <div class=" card-img">
              <img alt="Commercial Moving"
                class="lazy-image opacity-0 rounded-[6px]  sm:rounded-[20px] transition-opacity duration-500 ease-in-out w-full h-[auto] object-cover "
                v-lazy="'/imgs/map.png'" />
            </div>
            ...
            <div class="border rounded-md overflow-x-auto max-w-[350px] mx-auto mt-6"
              ...
              <table class="w-full text-left">
                <thead style="background-color: #ffd343;">
                  <tr>
                    <th class="text-black px-4 py-3 font-jakarta">Move Size</th>
                    <th class="text-black text-center px-4 py-3 font-jakarta">Average Cost</th>
                  </tr>
                </thead>
                <tbody>
                  <tr class="hover:bg-zinc-700">
                    <td class="px-4 py-3 font-rubik">1 Bedroom</td>
                    <td class="px-4 py-3 text-center font-rubik">$326 - $1,098</td>
                  </tr>
                  <tr class="bg-zinc-800 font-rubik hover:bg-zinc-700">
                    <td class="px-4 py-3">2-3 Bedrooms</td>
                    <td class="px-4 py-3 text-center">$732 - $2,570</td>
                  </tr>
                  <tr class=" font-rubik hover:bg-zinc-700">
                    <td class="px-4 py-3">4+ Bedrooms</td>
                    <td class="px-4 py-3 text-center">$1,251 - $3,836</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p class="leading-[26px] md:leading-[32px] font-[300] my-5 font-rubik">At Good View Moving and Storage, we
              ...
              from Jersey City to Montclair.</p>
            ...
            <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">Benefits of Choosing Good
              View Moving for
              Your Jersey City to Montclair Move</h2>
            <p class="leading-[26px] md:leading-[32px] font-[300] my-5 font-rubik">When you're planning a move from
              Jersey City to
              Montclair, you need a team you can rely on. At Good View Moving and Storage, we're proud to offer
            ...
            <p class="leading-[26px] md:leading-[32px] font-[300] my-5 font-rubik">Planning a local move doesn't have to
              be
            ...
            <p class="leading-[26px] md:leading-[32px] font-[300] my-5 font-rubik">Wondering How much does a local move
              usually
            ...
            <p class="leading-[26px] md:leading-[32px] font-[300] my-5 font-rubik">Get your instant quote today and see
              why we're
              considered one of the best local moving company options for moves from Jersey City to Montclair.</p>
            ...
            <div class="space-y-6">
              <div v-for="(faq, index) in faqs" :key="index" class="bg-[#1e1e1e] rounded-lg">
                ...
                <div v-if="openFaq === index" class="p-6">
                  <p class="leading-[26px] md:leading-[32px] font-[300]">{{ faq.answer }}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class='w-full lg:w-[30%] space-y-6'>
          <div class="p-6 pb-1 md:border-l border-gray-800">
            ...
            <div class='border-b-2 border-[#ffd343] mb-4 pb-[40px] pt-[20px]'>
              ...
              <div>
                <p class="mb-3">Get a Free Online Quote</p>
                <ULink to="/quote/"
