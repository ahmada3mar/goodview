                ...
                <div class="flex flex-col lg:flex-row bg-zinc-900 rounded-none p-3 md:p-10 gap-5 md:gap-10">
                    ...
                    <div class="flex-1 flex flex-col">
                        ...
                        <ul
                            ...
                            <li><span class="font-semibold">Packing & Preparation: </span> We use specialized <b><ULink  target="_blank" to="/services/packing-and-unpacking-service"
            class="font-[500]  underline ">
            packing materials</ULink></b> for your delicate items, ensuring everything is protected throughout the moving process.</li>
                ...
                <div
                    ...
                    <h2 class="text-2xl md:text-4xl font-jakarta font-extrabold text-black">What’s Included in Our Specialty Moving Service?
                    </h2>
                    <ul
            ...
            <div class=" flex flex-col gap-5 justify-center  rounded-[10px]  sm:p-5 p-2">
                ...
                <div class="flex flex-col  bg-white rounded-[10px] max-w-[1100px] p-3 md:p-8 ">
                    ...
                    <p class="text-lg md:text-xl mt-4 font-rubik  text-black">
                        The cost of Specialty Moving services depends on the type of items being moved and the complexity of the move.
                    </p>
                    <p class="text-lg md:text-xl mt-4 font-rubik  text-black">
