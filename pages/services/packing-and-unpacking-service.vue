            ...
            <div class="flex flex-col md:flex-row items-center mx-auto gap-6">
                ...
                <div class="md:w-2/3">
                 ...
                 <p class="text-lg font-rubik md:text-[18px] md:font-[300] md:leading-8">
                   ...
                   <p class="text-lg font-rubik md:text-[18px] md:font-[300] md:leading-8">
                      <b>High-Quality Materials: </b> We use the best packing supplies for moving, including materials for <b><a href="https://goodview-moving.com/services/specialty-moving-service"  target="_blank" class=" font-[500] underline "> fragile item packing</a></b>.</p>
    <p class="text-lg font-rubik md:text-[18px] md:font-[300] md:leading-8">
