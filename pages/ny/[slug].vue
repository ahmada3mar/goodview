                ...
                <div
                    ...
                    <div class="relative w-full md:w-[65%] items-baseline justify-center gap-6  py-10 container h-full">
                        <nav class="text-[12px] lg:text-[22px] font-rubik space-x-1 mt-2">
                            ...
                            <span>
                                <a href="/ny" class="hover:underline">New-york</a>
                            </span>
                            <span> / </span>
                        ...
                        <p class=" font-[300] max-w-3xl text-[18px]  tracking-[.3px] font-rubik leading-[1.6em]">
                            Estimated Cost: A move from {{ moving_route.title }} typically costs between<strong
                                class='text-[#ffd343] font-bold'> ${{ moving_route.min_cost }} and ${{
                                    moving_route.max_cost
                                }}.</strong> The total cost and time depend on several factors, including the size of
                            your move, your moving date, and whether you hire professional movers or handle the move
                            yourself.
                        </p>
                    </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col">
                                    <UInput :inputClass="errors.from ? '!border-red-500 focus:ring-red-500' : ''"
                                        ...
                                        <template #trailing>
                                            <UIcon role="button" name="i-carbon-location"
                                                class="w-5 h-5 font-jakarta text-black-400" />
                                        </template>
                                    </UInput>
                                    <span v-if="errors.from" class="text-red-500 font-jakarta font-bold">Please enter a
                                        valid ZIP
                                        code</span>
                                </div>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span v-if="errors.to" class="text-red-500 font-jakarta font-bold">Please enter a
                                        valid ZIP
                                        code</span>
                                </div>
                ...
                <div class='w-full md:w-[70%]'>
                    <div class="bg-zinc-900 rounded-lg p-4 md:p-8">
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em]">
                            At Good View Moving and Storage, we believe in providing clear, upfront pricing so you can
                            plan your
                            local
                            move with confidence. Based on our experience helping customers relocate along this route,
                            the
                            average
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">The final
                            price
                            depends on
                            several factors, including the size of your move, the services you select, and your specific
                            moving
                            date.
                            Whether you need full-service packing, local moving services, or simply transportation for
                            your
                            belongings, we offer flexible options to fit your needs and budget.</p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Here's a
                            breakdown
                            of the average
                            moving costs
                            for this route:</p>
                        <div class="border rounded-md overflow-x-auto max-w-[350px] mx-auto mt-6"
                            ...
                            <table class="w-full text-left">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="item in moving_route.move_size_cost" :key="item.id"
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Please note:
                            These
                            price ranges are
                            rough
                            estimates based on our customer relocation data. The actual cost may vary depending on the
                            size of
                            your
                            move, additional services required, truck parking access and availability.</p>
                        <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">Factors
                            Affecting the
                            Cost
                            of {{ moving_route.title }}</h2>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">At Good View
                            Moving
                            and Storage, we
                            believe
                            every move is unique — and so is the final cost. Several key factors can influence the price
                            of your
                            move
                            {{ moving_route.title }}.</p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Here's what
                            can
                            affect your moving
                            cost with us:
                        </p>
                        <ul class='list-disc pl-7 font-rubik'>
                            <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                                    ...
                                    of Your Move: </strong> Larger homes or apartments mean more items to pack, load,
                                and
                                transport, which
                                can increase the overall cost. For example, moving a 2-3 bedroom home will cost more
                                than a
                                small
                                apartment.</li>
                            <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                                    class='font-[600] text-[18px]'>Type
                                    of Services You Need: </strong>Full-service options, such as professional packing,
                                unpacking,
                                furniture disassembly, or storage, will influence your total moving cost. We offer
                                flexible
                                packages for
                                every need.</li>
                            <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                                    class='font-[600] text-[18px]'>Accessibility at Pickup and Drop-off Locations:
                                </strong>If
                                our trucks
                                have limited access, elevators are unavailable, or parking is difficult, it may affect
                                the
                                price.</li>
                            <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                                    class='font-[600] text-[18px]'>Move
                                    Date and Time: </strong>Moving during peak seasons, weekends, or holidays can
                                increase
                                demand, which
                                may raise rates. Booking early with Good View Moving NJ often secures better pricing.
                            </li>
                            <li class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-2"><strong
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Our goal is
                            to
                            provide affordable
                            local moving
                            services with clear, upfront pricing. Good View Moving and Storage is proud to be among the
                            best
                            local
                            movers serving this route.</p>
                        <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">Benefits of
                            Choosing
                            Good
                            View Moving {{ moving_route.title }} Move</h2>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">When you're
                            planning
                            a move {{
                            moving_route.title }}, you need a team you can rely on. At Good View Moving and Storage,
                            we're proud
                            to
                            offer
                            dependable, affordable, and stress-free moving solutions for both local and long distance
                            moving.
                        </p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Here's why
                            so many
                            customers consider
                            us among
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                                ...
                                Experienced, Professional Team: </strong> Our movers are trained, licensed, and
                            experienced in
                            handling
                            local moving projects of all sizes. From packing to transport, your belongings are in safe
                            hands.
                        </p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                                class='font-[600] text-[18px]'>
                                <span style="color: #ffd343; margin-right: 6px;">✓</span>Affordable and Transparent
                                Pricing:
                            </strong>
                            We believe in honest, upfront pricing. Whether you're searching for moving companies near me
                            or
                            planning a
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                            ...
                            Every move is different. We provide a range of services, from basic transportation to
                            full-service
                            packing, storage, and specialty item handling. Our local moving services can be customized
                            to meet
                            your
                            specific needs.</p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                                class='font-[600] text-[18px]'>
                                <span style="color: #ffd343; margin-right: 6px;">✓</span>
                                Highly Rated and Trusted: </strong>We take pride in positive Good View Moving reviews
                            from
                            satisfied
                            customers. Our commitment to reliability, care, and exceptional customer service has
                            established us
                            as a
                        ...
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5"><strong
                                class='font-[600] text-[18px]'>
                                <span style="color: #ffd343; margin-right: 6px;">✓</span>
                                Stress-Free Moving Process: </strong>Our goal is simple — to make your move smooth and
                            worry-free.
                            Whether you need local movers near me or professional packing help, we're with you every
                            step of the
                            way.
                        </p>
                        <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">Get an Instant
                            Quote for
                            Your Move Today
                        </h2>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Planning a
                            local
                            move doesn't have to
                            be
                            stressful — let Good View Moving and Storage make it simple. Whether you're relocating
                            within {{
                            fromCity }}
                            or moving a short distance, we're here to help with transparent pricing and professional
                            service.
                        </p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">With just a
                            few
                            details, you can
                            receive a fast
                            and free quote tailored to your move. We provide honest estimates based on the size of your
                            move,
                            distance, and any additional services you may need, including packing or storage options.
                        </p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Wondering
                            How much
                            does a local move
                            usually
                            cost? Start by getting your personalized quote with Good View Moving local moving services.
                        </p>
                        <p class="font-[300]  text-[18px]  tracking-[.3px] font-rubik leading-[1.6em] my-5">Get your
                            instant
                            quote today and see
                            why we're
                            considered one of the best local moving company options for moves {{ moving_route.title }}.
                        </p>
                    ...
                    <div class="w-full py-4 md:px-[32px] px-0 ">
                        ...
                        <h2
                            ...
                            But don't just take our word for it — see what our customers have to say about their
                            experience with
                            our
                            New
                        ...
                        <div class="flex items-center justify-center">
                            <div class="relative  max-w-6xl overflow-hidden rounded-2xl">
                                <div class="flex w- justify-center">
                                    <div v-for="(testimonial, index) in visibleTestimonials"
                                        ...
                                        <div class="relative">
                                            ...
                                            <p class="text-black font-[300] text-[16px] font-rukik leading-relaxed">{{
                                                testimonial.review }}
                                            </p>
                                        </div>
                                    </div>
