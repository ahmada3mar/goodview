          ...
          <div
            ...
            <div class="relative w-full md:w-[65%] items-baseline justify-center gap-6  py-10 container h-full">
              ...
              <h1 class=" text-[28px] md:text-[40px] lg:text-[56px] mb-4 font-[700] font-jakarta">
                <strong class=" text-[#ffd343]"> (${{ moving_route.min_cost }})</strong> Moving {{ moving_route.title }}
              </h1>
              <p class=" font-[300] max-w-3xl font-rubik leading-[1.6rem]">
                Estimated Cost: A move {{ moving_route.title }} typically costs between<strong
                  class='text-[#ffd343] font-bold'> ${{ moving_route.min_cost }} and ${{ moving_route.max_cost }}.</strong> The total cost and time depend
        ...
        <div class='max-w-[1360px] w-full mx-auto flex flex-col md:flex-row gap-8 px-[20px] xl:px-0'>
          <div class='w-full md:w-[70%]'>
            <div class="bg-zinc-900 rounded-lg p-4 md:p-8">
              <h2 class="text-xl md:text-[38px] leading-normal font-[600] mb-6 font-jakarta">Cost of Moving {{ moving_route.title }} with Good View Moving?</h2>
              <p class="leading-[26px] md:leading-[32px] font-[300] mb-6">
                ...
                cost to move {{ moving_route.title }} typically falls between <strong
                  class='text-[#ffd343]  font-bold'>${{ moving_route.min_cost }}</strong> and<strong class='text-[#ffd343]  font-bold'>
              ...
              <p class="leading-[26px] md:leading-[32px] font-[300] my-5 font-rubik">When you're planning a move {{ moving_route.title }}, you need a team you can rely on. At Good View Moving and Storage, we're proud to offer
