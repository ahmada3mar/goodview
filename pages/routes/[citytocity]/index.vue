            ...
            <div class="relative w-full md:w-[65%] items-baseline justify-center gap-6 py-10 container h-full">
              <nav
                ...
                <template v-if="fromCityObj">
                  <NuxtLink :to="`/${fromStateObj.slug}/${fromCityObj.slug}/`" class="hover:underline">{{
              ...
              <p class="font-[300] max-w-3xl text-[18px] tracking-[.3px] font-rubik leading-[1.6em]">
                ...
                {{ toCity }} typically costs between<strong class="text-[#ffd343] font-bold">
                  ${{ moving_route.min_cost }} and ${{
                    moving_route.max_cost
                  }}.</strong>The total cost and time depend on several factors, including
                ...
                <div
                  ...
                  <div class="flex flex-col">
                    <UInput :inputClass="errors.from ? '!border-red-500 focus:ring-red-500' : ''
                      ...
                      placeholder="From zip code" maxlength="5" :ui="{
                  ...
                  <div class="flex flex-col">
                    <UInput :inputClass="errors.to ? '!border-red-500 focus:ring-red-500' : ''
                      ...
                      placeholder="To zip code" maxlength="5" :ui="{
        ...
        <div class="max-w-[1360px] w-full mx-auto flex flex-col md:flex-row gap-8 px-[20px] xl:px-0">
          <div class="w-full md:w-[70%]">
            <div class="bg-zinc-900 rounded-lg p-4 md:p-8">
              <h2 class="text-xl md:text-[38px] leading-normal font-[600] mb-6 font-jakarta">
              ...
              <p class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em]">
                ...
                <strong class="text-[#ffd343] font-bold">${{ moving_route.min_cost }}</strong>
              ...
              <p class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-5">
              ...
              <h2 class="text-xl md:text-[38px] leading-[1.5em] font-[600] mb-6 font-jakarta">
              ...
              <ul class="list-disc pl-7 font-rubik">
                <li class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-2">
                  <strong class="font-[600] text-[18px]">Size of Your Move:
                  </strong>
                ...
                <li class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-2">
                  <strong class="font-[600] text-[18px]">Distance of the Move: </strong>Some customers book long
                  distance
                  moving services for routes
                  beyond city limits, which affects pricing.
                </li>
                <li class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-2">
                  <strong class="font-[600] text-[18px]">Type of Services You Need:
                  </strong>
                ...
                <li class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-2">
                  <strong class="font-[600] text-[18px]">Accessibility at Pickup and Drop-off Locations: </strong>If our
                  trucks have limited access, elevators are unavailable,
                  or parking is difficult, it may affect the price.
                </li>
                <li class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-2">
                  <strong class="font-[600] text-[18px]">Move Date and Time:
                  </strong>
                ...
                <li class="font-[300] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-2">
                  <strong class="font-[600] text-[18px]">Specialty Items: </strong>Large or delicate items such as
                  pianos,
                  antiques, or fragile
              ...
              <p class="font-[700] text-[18px] tracking-[.3px] font-rubik leading-[1.6em] my-5">
...
// Update the Google Maps script creation
onMounted(async () => {
  fetchBlogs();
  ...
  if (
    ...
    if (!document.getElementById("google-maps-script")) {
      ...
      script.src = `https://maps.googleapis.com/maps/api/js?key=${config.public.googleMapsApiKey}&libraries=places,geometry,directions&callback=initMap&loading=async`;
      script.async = true;
      script.defer = true;
